...
- PANGEA protocols: Gall (TOCITE) and Bonsall et al.[@bonsall_comprehensive_2018]
...
of size 50, and aim to build ony phylogeny per group, per 250 bp long genetic 
window.
...
- aligning to compare "apples to apples": MAFFT TOCITE
...
- Phylogenies are made through IQTREE by group and window through IQTREE (TOCITE)
...
## Summary { background-color="`r clrs_lt[2]`"}
